...
?>
<div class="container pt-3 pb-2 showMain one-content">
  <div class="row backgroundSvg">
    <svg class="poster" xmlns="http://www.w3.org/2000/svg" id="f080dbb7-9b2b-439b-a118-60b91c514f72" data-name="Layer 1" width="528.71721" height="699.76785" viewBox="0 0 528.71721 699.76785">
      <title>Login</title>
      <rect y="17.06342" width="444" height="657" fill="#535461" />
      <polygon points="323 691.063 0 674.063 0 17.063 323 0.063 323 691.063" fill="#c82333" />
      ...
      <polygon points="337 691.063 317.217 691 318 0.063 337 0.063 337 691.063" fill="#c82333" />
      <g opacity="0.1">
      ...
      <path d="M735.8586,266.93948s-13,0-16,18-6,78-6,78-42,55-35,62,15,20,20,18,48-61,48-61Z" transform="translate(-335.6414 -100.11607)" fill="#28a745" />
      ...
      <path d="M820.3586,253.43948l-10.5,10.5s-32,12-47,0c0,0,5.5-11.5,5.5-10.5s-43.5,7.5-47.5,25.5,3,49,3,49-28,132-17,135,114,28,113,9,8-97,8-97l35-67s-5-22-17-29S820.3586,253.43948,820.3586,253.43948Z" transform="translate(-335.6414 -100.11607)" fill="#28a745" />
      ...
      <path d="M853.8586,298.93948l9,9s6,84-6,101-67,63-70,60-22-18-18-20,57.18287-57.56942,57.18287-57.56942l-4.18287-77.43058Z" transform="translate(-335.6414 -100.11607)" fill="#28a745" />
    ...
    <form class="col my-auto" method="POST" action="?act=login&task=verify">
      <h3>Log In</h3>
      ...
      <p>Don't have an account ? <a class="text-x-large" href="?act=signin">Create one!</a></p>
    </form>
  </div>
</div>